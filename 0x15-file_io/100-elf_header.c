...
/**
 * Description: a function prints the magic number of an elf header
 * print_magic - a function that prints the magic number of
 * elf header
 * @e_ident: a pointer to an array contating the elf magic number
 */
void print_magic(unsigned char *e_ident)
{
	int index;
...
/**
 * print_abi 0 a function that prints the ABI version of an elf header
 * @e_ident: a pointer to an array contating the elf magic number
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * contained in the elf header at the start of elf file
